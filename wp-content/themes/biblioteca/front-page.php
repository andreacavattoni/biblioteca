...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <header class="header home-header">
    <div class="home-title"><h1><?php echo esc_html( $hero_title ); ?></h1></div>
    <?php if ( $hero_cover ) : ?>
    <div class="home-image container-fluid">
      <img src="<?php echo esc_url( $hero_cover['url'] ); ?>" alt="<?php echo esc_attr( $hero_title ); ?>">
    </div>
    <?php endif; ?>
  </header>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-7">
          ...
          <h2 class="big-title big"><?php echo esc_html( $biblioteca['title'] ); ?></h2>
          <?php endif; ?>
          <?php if ( ! empty( $biblioteca['text'] ) ) : ?>
          <div class="mini-text mini light"><?php echo wp_kses_post( wpautop( $biblioteca['text'] ) ); ?></div>
          <?php endif; ?>
        </div>
  ...
  <div class="sect home-libri">
    <div class="container-fluid">
      <div class="row mb-4">
        <div class="col-md-8">
          <?php if ( $libri_title ) : ?>
          <div class="mini-text mini light"><?php echo esc_html( $libri_title ); ?></div>
          <?php endif; ?>
          <?php if ( $libri_text ) : ?>
          <div class="big-title big"><?php echo esc_html( $libri_text ); ?></div>
          <?php endif; ?>
        </div>
      </div>
  ...
  <div class="sect home-progetti">
    <div class="container-fluid">
      <div class="row mb-4 align-items-center">
        <div class="col-md-8">
          <?php if ( $progetti_tit ) : ?>
          <div class="mini-text mini light"><?php echo esc_html( $progetti_tit ); ?></div>
          <?php endif; ?>
        </div>
      </div>
      <div class="row progetti-grid">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="proj-card">
            <?php if ( $p_image ) : ?><img src="<?php echo esc_url( $p_image['url'] ); ?>" alt="<?php echo esc_attr( $p_title ); ?>"><?php endif; ?>
            <div class="proj-body">
              <div class="proj-title"><?php echo esc_html( $p_title ); ?></div>
              <div class="proj-text"><?php echo wp_kses_post( $p_text ); ?></div>
              <?php if ( $p_link ) : ?><a class="btn no-bk" href="<?php echo esc_url( $p_link ); ?>" target="_blank" rel="noopener">Scopri progetto<span></span></a><?php endif; ?>
            </div>
          </div>
        </div>
        <?php endforeach; ?>
